		...
		<div style="padding-top:20vh">
			<div class="login-container">
				...
				<div class="login-header">
					<span class="login-header-title"><h1>PESU eLearning</h1></span>
				</div>
				<!-- LOGIN CONTENT -->
				<div class="login-content">
					...
					<form method="post" id="loginForm" class="login-form">
						<div class="login-form-group">
							<label>UserID</label>
							<input type="text" name="userid" class="form-input" id="userid" placeholder="Admin/Faculty/Student ID..." REQUIRED>
						</div>
						<div class="login-form-group">
				...
				<div class="login-footer">
					Dont have an account? Register as <a href="register-student.php">Student</a> Or <a href="register-teacher.php">Teacher</a>
					<br><br>
				</div>
			</div>
		</div>
